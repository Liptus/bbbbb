...
import kotlinx.android.synthetic.main.game.gameImage
import kotlinx.android.synthetic.main.game.nameText
...
class GameView : AppCompatActivity() {
    ...
    private fun changeFavoriteStatus(it : View) {
        ...
        Snackbar.make(it,if (gameItem.favorite) "Favorilere eklendi !" else "Favorilerden kaldırıldı !",Snackbar.LENGTH_SHORT)
            .setBackgroundTint(if (gameItem.favorite) Color.rgb(50,70,50) else Color.BLACK).show()
    }
